...
**1. Google Cloud, once.** Create a project, enable **YouTube Data API v3** and
**YouTube Analytics API**, create an OAuth client of type *Desktop app*, download
`client_secrets.json`.
